...
Public Class _default1
        ...
        If method.ToLower = "get" Then
            ...
            Try
                ...
                If IsNothing(ok) Then
                    myResponse(context, New NormalResponse(False, "WorkLogTemp 您的请求GET func出现未预料的错误"))
                    Return
                End If
            ...
            Catch ex As Exception
                myResponse(context, New NormalResponse(False, "WorkLogTemp_您的请求GET func出现了错误", "", ex.ToString()))
                Return
            End Try
            myResponse(context, New NormalResponse(False, "WorkLogTemp_您的请求GET func不在受理范围内", "", context.Request.Url.PathAndQuery))
            Return
        End If
        myResponse(context, New NormalResponse(False, "WorkLogTemp 您的请求func不在受理范围内", "", context.Request.Url.PathAndQuery))
    End Sub
    ...
    Sub HandlePost(ByVal context As HttpContext)
        ...
        End Try
        myResponse(context, New NormalResponse(False, "WorkLogTemp您的请求POST func不在受理范围内", "", context.Request.Url.PathAndQuery))
    End Sub
